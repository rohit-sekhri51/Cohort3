...
// console.log(process.env.PRIVATE_KEY + " " + process.env.ENDPOINT);
...
/*
const requiredEnvVars = ['PRIVATE_KEY', 'ENDPOINT'];
    ...
    console.log(`PRIVATE_KEY length: ${process.env.PRIVATE_KEY.length} characters`); 
*/
